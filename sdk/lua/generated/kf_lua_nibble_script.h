 ...
 * from examples/creature_demo/nibble.lua. lua_embed_check
...
#ifndef KF_LUA_NIBBLE_SCRIPT_H
#define KF_LUA_NIBBLE_SCRIPT_H

inline constexpr const char *kKfLuaNibbleScriptSource = R"lua(
-- SPDX-License-Identifier: Apache-2.0
-- Copyright the Kamiframe contributors.
--
...
inline constexpr const char *kKfLuaNibbleScriptChunkName =
    "=nibble";

#endif /* KF_LUA_NIBBLE_SCRIPT_H */
